...
$con = mysql_connect("mysql8.000webhost.com","a3183760_admin","1nternet");
if (!$con)
{
	die('Could not connect: ' . mysql_error());
}

mysql_select_db("a3183760_coords", $con);
$name=$_POST['id'];
...
#optContainer{height:100px; width:105px; -webkit-transform:rotate(270deg);}
